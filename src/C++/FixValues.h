...
namespace FIX
{
  ...
  const char TradingSessionSubID_PRE_TRADING[] = "0";
  ...
  const char TradingSessionSubID_POST_TRADING[] = "2";
  const char TradingSessionSubID_INTRADAY_AUCTION[] = "5";
  const char TradingSessionSubID_QUIESCENT[] = "7";
  const char TradingSessionSubID_TRADING[] = "1";
  const char TradingSessionSubID_AFTER_HOUR[] = "3";
  const char TradingSessionSubID_CLOSED[] = "4";
  const char TradingSessionSubID_RE_OPENING[] = "6";
  const char TradingSessionSubID_CLOSING_PRICE_CROSS[] = "z";
  ...
  const int TrdType_ALLOCATION = 1001;
  const int TrdType_GIVE_UP = 1002;
  const int TrdType_FLOOR_TRADE = 1003;
